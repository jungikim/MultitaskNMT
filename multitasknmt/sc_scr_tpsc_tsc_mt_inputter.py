...
class ScScrTpscTscMtInputter(ScTpscTscMtInputter):
    def __init__(
        self,
        features_inputter,
        labels_inputter,
        ...
        super().__init__(
            ...
            translation_span_corruption_noise_density = translation_span_corruption_noise_density,
            translation_span_corruption_mean_noise_span_length = translation_span_corruption_mean_noise_span_length,
        )
    ...
    def get_dataset_size(self, data_file):
        ...
        monolingual_data_file[0], monolingual_data_file[1], \
        bilingual_data_file[0], bilingual_data_file[1] = \
                                    ScTpscTscMtInputter._separate_into_mono_bi(data_file)
        ...
        size = mono_src_size + mono_tgt_size + 3 * bi_size
